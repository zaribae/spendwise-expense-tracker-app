...
const ChatIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" /></svg>;
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <aside className="lg:w-1/4">
                        <div className="bg-white p-4 rounded-xl shadow-md border border-slate-200 space-y-2">
                            ...
                            <NavButton tabName="advisor" icon={<ChatIcon />}>AI Advisor</NavButton>
                        </div>
                    </aside>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-blue-50 border-l-4 border-blue-500 rounded-r-lg p-5 mb-6 flex flex-col sm:flex-row items-center justify-between shadow-sm">
                                    <div className="flex items-center mb-4 sm:mb-0">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-bold text-blue-900">New: DompetHub Telegram Bot! 🚀</h3>
                                            <p className="text-blue-700 text-sm mt-1">
                                                Log expenses and chat with your AI Advisor directly from Telegram. Fast, smart, and fully synced.
                                            </p>
                                        </div>
                                    </div>

                                    {/* Link this button to your Profile page where the "Connect Telegram" button is */}
                                    <button
                                        onClick={() => setActiveTab('profile')}
                                        className="bg-blue-500 hover:bg-blue-600 transition-colors text-white font-semibold py-2 px-5 rounded-lg whitespace-nowrap shadow-sm"
                                    >
                                        Connect Now
                                    </button>
                                </div>
